    ...
    return(
        <section className="menu-ppal">
            <Link to="/campanhas" id="menu-ppal-campanhas" title="Mis campañas" target="_self">
                <img src="assets/img/icon_campanha.png" alt="Icono de campaña" />
                <span>Campañas</span>
            </Link>
            <Link to="/sesiones" id="menu-ppal-sesiones" title="Mis sesiones" target="_self">
                <img src="assets/img/icon_sesion.png" alt="Icono de sesión" />
                <span>Sesiones</span>
            </Link>
            <Link to="/personajes" id="menu-ppal-personajes" title="Mis personajes" target="_self">
                <img src="assets/img/icon_personaje.png" alt="Icono de personaje" />
                <span>Personajes</span>
            </Link>
            <Link to="/razas" id="menu-ppal-razas" title="Mis razas" target="_self">
                <img src="assets/img/icon_raza.png" alt="Icono de raza" />
                <span>Razas</span>
            </Link>
            <Link to="/calendario" id="menu-ppal-calendario" title="Mi calendario" target="_self">
                <img src="assets/img/icon_calendario.png" alt="Icono de calendario" />
                <span>Calendario</span>
            </Link>
            <div>
                <img id="dado" src="assets/img/dado.png" title="Tirar dado" alt="Imagen de un dado de 20 caras" onClick={tirarDado} />
