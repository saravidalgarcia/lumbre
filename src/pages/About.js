...
/**
 * Componente que representa la interfaz de información y contacto - Lumbre
 * 
...
function About(props) {
    ...
    //Alternativa sin cabecera (usuario sin autenticar)
    let sinCabecera = <>{main}<Footer /></>;
    //Alternativa con cabecera (usuario autenticado)
    let conCabecera = <><Cabecera />{main}<Footer /></>;

    /**
     * Contenido de la interfaz de información y contacto
     */
